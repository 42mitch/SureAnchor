...
import {
  ...
  Cpu, Megaphone, Target, BarChart2
} from 'lucide-react';
import {
...
export default function AdminDashboard() {
  ...
  const loading = loadingResidents || loadingDonations;
                ...
                <div>
                  ...
                  <ResponsiveContainer width="100%" height={200}>
                    <BarChart data={socialPlatformData} layout="vertical" barSize={10}>
                      ...
                      <Tooltip formatter={(v: number) => [`${v.toFixed(2)}%`, 'Engagement']} />
            ...
            <div>
              ...
              <ResponsiveContainer width="100%" height={180}>
                <AreaChart data={monthlyTrend}>
                  ...
                  <Tooltip formatter={(v: number) => [fmt(v), 'Total donations']} />
